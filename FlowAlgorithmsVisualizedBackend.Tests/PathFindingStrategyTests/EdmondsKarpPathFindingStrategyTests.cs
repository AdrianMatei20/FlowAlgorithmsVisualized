// <copyright file="EdmondsKarpPathFindingStrategyTests.cs" company="Universitatea Transilvania din Brașov">
// Matei Adrian
// </copyright>
...
namespace FlowAlgorithmsVisualizedBackend.Tests.PathFindingStrategyTests
{
    ...
    /// <summary>Test class for the <b>path finding strategy</b> of the <b>Edmonds-Karp Algorithm</b>.</summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    internal class EdmondsKarpPathFindingStrategyTests
    {
        ...
        private void CreatePathFindingStrategy(int i)
        {
            ...
            this.pathFindingStrategy = new EdmondsKarpPathFinding();
        }

        /// <summary>Test for the <b>path finding strategy</b> of the <b>Edmonds-Karp Algorithm</b> (Iteration 1).</summary>
        [Test]
        [Repeat(50)]
        public void EdmondsKarp_1()
        {
        ...
        /// <summary>Test for the <b>path finding strategy</b> of the <b>Edmonds-Karp Algorithm</b> (Iteration 2).</summary>
        [Test]
        [Repeat(50)]
        public void EdmondsKarp_2()
        {
        ...
        /// <summary>Test for the <b>path finding strategy</b> of the <b>Edmonds-Karp Algorithm</b> (Iteration 3).</summary>
        [Test]
        [Repeat(50)]
        public void EdmondsKarp_3()
        {
        ...
        /// <summary>Test for the <b>path finding strategy</b> of the <b>Edmonds-Karp Algorithm</b> (Iteration 4).</summary>
        [Test]
        [Repeat(50)]
        public void EdmondsKarp_4()
        {
        ...
        /// <summary>Test for the <b>path finding strategy</b> of the <b>Edmonds-Karp Algorithm</b> (Iteration 5).</summary>
        [Test]
        [Repeat(50)]
        public void EdmondsKarp_5()
        {
