...
namespace FlowAlgorithmsVisualizedBackend.Tests.AlgorithmTests
{
    ...
    internal class AlgorithmFactoryTests
    {
        ...
        public void AlgorithmFactoryTest_0()
        {
            ...
            Mock<IFileHelperFactory> fileHelperFactoryMock = new Mock<IFileHelperFactory>();
            fileHelperFactoryMock.Setup(x => x.GetFileHelper()).Returns(fileHelperMock.Object);

            IAlgorithmFactory algorithmFactory = new AlgorithmFactory(fileHelperFactoryMock.Object);
