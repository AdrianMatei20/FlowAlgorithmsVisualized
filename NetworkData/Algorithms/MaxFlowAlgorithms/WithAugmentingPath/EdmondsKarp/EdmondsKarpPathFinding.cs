// <copyright file="EdmondsKarpPathFinding.cs" company="Universitatea Transilvania din Brașov">
// Matei Adrian
// </copyright>
...
namespace FlowAlgorithmsVisualizedBackend.Algorithms
{
    ...
    /// <summary>Class that implements the path finding strategy of the <b>Edmonds-Karp Algorithm</b>.</summary>
    /// <seealso cref="IFindPathStrategy"/>
    internal class EdmondsKarpPathFinding : IFindPathStrategy
    {
        /// <inheritdoc/>
